...
ICON_SOURCE="/Users/ultramacuser/Downloads/NALA-AudiO-ViZuLiZeR_ArchiVE/NALA-AudioO-Visualizer-ICON/NALA-AudioO-Visualizer-ICON-ChatGPT-(FINAL).png"
...
/usr/libexec/PlistBuddy -c "Add :CFBundleShortVersionString string 0.3.8" "$APP_BUNDLE/Contents/Info.plist"
